...
const Player1Registration = () =>{
    ...
    function HandleSubmit() {
        ...
        const CountryCodeSelect = document.getElementById("countryCode"); // Add this line
        ...
        // Check if a country code was selected
        // if (CountryCodeSelect.selectedIndex === 0) {
        //     document.getElementById('error').innerHTML = "PLEASE SELECT A COUNTRY CODE";
        //     return;
        // }
